...
# 📌 Load Model
model = load_model(r"C:\PROJECT\Umpire Environment\All umpire signals LSTM+Mediapipe\mp hand pose\YOLO + MP + LSTM\LSTM weights\LSTM_Model_T7.h5")

# 📌 Define Class Labels
class_labels =  ["No Action", "No Ball","Four","Wide","Out","Revoke","Penality","Bye","Leg Bye","Short Run","Six","Dead Ball"] # Update based on training
...
# 📌 Start Webcam
video_path = r"c:\Users\praga\Downloads\videos\deadball5min.mp4"
