...
sample_img = cv2.imread(r'c:\Users\praga\OneDrive\Pictures\Screenshots\Screenshot (216).png')
...
#camera_video = cv2.VideoCapture(r'Umpire Videos/Umpire vid real/Wide (2).mp4')
