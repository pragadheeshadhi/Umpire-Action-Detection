...
# 📌 Save Model
model_path = r"C:\PROJECT\Umpire Environment\All umpire signals LSTM+Mediapipe\mp hand pose\Models1\LSTM_Model3.h5"
model.save(model_path)

# 📌 Ensure TensorFlow clears memory
