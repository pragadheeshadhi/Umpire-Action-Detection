...
for idx, signal in enumerate(signals):
    file_path = rf"C:\PROJECT\Umpire Environment\All umpire signals LSTM+Mediapipe\mp hand pose\Data1\{signal}.csv"
...
# 📌 Save Model
model.save(r"C:\PROJECT\Umpire Environment\All umpire signals LSTM+Mediapipe\mp hand pose\Models1\LSTM_Model.h5")
